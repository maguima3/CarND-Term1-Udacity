...
public:
	...
	/**
	 * Prints out map infos and measurement package
	 */
	void printDataInfo(map& map_1d, std::vector<MeasurementPackage>& measurement_pack_list) {

		printf("*************************************************\n");
		printf("Printing out map information...\n");	
		printf("*************************************************\n");

		std::cout << "Print out the map landmarks:" << std::endl;
		...
		//print out the controls and observations
	...
	*****************************************************************************/
    ...
    // Return if we can't open the file.
    if (!in_file_gt) {
      std::cout << "Problem reading gt file." << std::endl;
      return false;
    }
