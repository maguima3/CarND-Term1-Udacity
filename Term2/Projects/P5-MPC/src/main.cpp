    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          std::cout << "delta=" << delta << "\ta=" << acceleration << std::endl;
          ...
          */
          ...
          Eigen::VectorXd x_waypoints(n_waypoints);
          Eigen::VectorXd y_waypoints(n_waypoints);
          ...
          // A third order polynomial is fitted to waypoints.
          Eigen::VectorXd coeffs = polyfit(x_waypoints, y_waypoints, 3);

          // Car's position in vehicle's coodinate system
          px = 0.0;
          py = 0.0;
          psi = 0.0;
          ...
          // and subtracting y.
          // Car's location in vehicle's coordinate system: (0, 0, 0)
